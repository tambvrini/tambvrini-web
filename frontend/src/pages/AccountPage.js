  ...
  return (
    <div data-testid="account-page" className="min-h-screen pt-32 md:pt-40 pb-24">
      <div className="max-w-md mx-auto px-6">
        <h1 className="font-cinzel text-3xl md:text-4xl tracking-[0.1em] text-marble text-center mb-4">
          {isLogin ? 'Iniciar Sesión' : 'Crear Cuenta'}
        </h1>
        <p className="font-montserrat text-xs text-marble/40 text-center mb-12 tracking-wide">
        ...
        <button
          ...
          className="w-full py-4 border border-white/10 font-montserrat text-[11px] tracking-[0.15em] uppercase text-marble/70 hover:border-white/30 hover:text-marble transition-colors duration-300 mb-8 flex items-center justify-center gap-3"
        >
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <span className="font-montserrat text-[10px] text-marble/20 tracking-widest uppercase">o</span>
          <div className="flex-1 h-px bg-white/5" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {!isLogin && (
            <div>
              <label className="font-montserrat text-[10px] tracking-[0.2em] uppercase text-marble/40 block mb-2">Nombre</label>
              <input
