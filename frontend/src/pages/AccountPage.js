...
export default function AccountPage() {
  const { user, login, register, logout, startGoogleLogin, loading } = useAuth();
      ...
      <div className="max-w-md mx-auto px-6">
        ...
        <div className="mb-8">
          <button
            ...
            className="w-full py-4 border border-black/10 font-montserrat text-[11px] tracking-[0.15em] uppercase text-obsidian/70 hover:border-black/30 hover:text-obsidian transition-colors duration-300 flex items-center justify-center gap-3"
          >
            ...
            {googleSubmitting ? 'Procesando...' : 'Continue with Google'}
          </button>
        </div>
