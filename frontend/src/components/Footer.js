          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 w-full items-start">
              ...
              <ul className="space-y-3">
                {[t('contacto'), t('mi_pedido'), t('faq')].map((item) => (
                  <li key={item}>
                    <button
                      type="button"
                      className={`font-montserrat text-xs ${IVORY_TEXT_CLASS} hover:text-white tracking-wide transition-colors duration-300`}
                    >
                      {item}
                    </button>
                  </li>
            ...
            <div className="flex flex-col items-center lg:items-end text-center lg:text-right">
              ...
              <div className="mt-8">
                ...
                >
                  <option value="es" className="text-obsidian" style={{ backgroundColor: PASTEL_BLUE }}>Español</option>
                  <option value="en" className="text-obsidian" style={{ backgroundColor: PASTEL_BLUE }}>English</option>
                  <option value="fr" className="text-obsidian" style={{ backgroundColor: PASTEL_BLUE }}>Français</option>
                  <option value="it" className="text-obsidian" style={{ backgroundColor: PASTEL_BLUE }}>Italiano</option>
                </select>
              </div>
            </div>
          </div>
